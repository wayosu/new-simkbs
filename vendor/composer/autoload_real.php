...
class ComposerAutoloaderInitdb9691f115cf6cc827e93c461c8622b9
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitdb9691f115cf6cc827e93c461c8622b9::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiredb9691f115cf6cc827e93c461c8622b9($fileIdentifier, $file);
        }
...
function composerRequiredb9691f115cf6cc827e93c461c8622b9($fileIdentifier, $file)
{
