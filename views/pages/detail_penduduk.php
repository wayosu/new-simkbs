                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-primary"><?php
                                                                if ($row['BAHAN_MAKANAN'] == '1') {
                                                                    echo 'Daging';
                                                                } else if ($row['BAHAN_MAKANAN'] == '2') {
                                                                    echo "Susu";
                                                                } else if ($row['BAHAN_MAKANAN'] == '3') {
                                                                    echo "Ayam";
                                                                } else {
                                                                    echo "Lainnya";
                                                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-primary"><?php
                                                                if ($row['PAKAIAN_PER_TAHUN'] == '0') {
                                                                    echo 'Tidak Pernah';
                                                                } else if ($row['PAKAIAN_PER_TAHUN'] == '1') {
                                                                    echo "1 Stel";
                                                                } else if ($row['PAKAIAN_PER_TAHUN'] == '2') {
                                                                    echo "2 Stel";
                                                                } else if ($row['PAKAIAN_PER_TAHUN'] == '3') {
                                                                    echo "3 Stel";
                                                                } else {
                                                                    echo "Lainnya";
                                                                }
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-primary"><?php
                                                                if ($row['FREKUENSI_PER_MINGGU'] == '0') {
                                                                    echo 'Tidak Pernah';
                                                                } else if ($row['FREKUENSI_PER_MINGGU'] == '1') {
                                                                    echo "1 Kali Seminggu";
                                                                } else if ($row['FREKUENSI_PER_MINGGU'] == '2') {
                                                                    echo "2 Kali Seminggu";
                                                                } else if ($row['FREKUENSI_PER_MINGGU'] == '3') {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-primary"><?php
                                                                if ($row['MAKAN_PER_HARI'] == '0') {
                                                                    echo 'Tidak Pernah';
                                                                } else if ($row['MAKAN_PER_HARI'] == '1') {
                                                                    echo "1 Kali Sehari";
                                                                } else if ($row['MAKAN_PER_HARI'] == '2') {
                                                                    echo "2 Kali Sehari";
                                                                } else if ($row['MAKAN_PER_HARI'] == '3') {
                                                                    echo "3 Kali Sehari";
                                                                } else {
                                                                    echo "Lainnya";
                                                                }
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="text-primary"><?php
                                                                if ($row['JENIS_TABUNGAN'] == '1') {
                                                                    echo 'Sepeda Motor Kredit';
                                                                } else if ($row['JENIS_TABUNGAN'] == '2') {
                                                                    echo 'Emas';
                                                                } else if ($row['JENIS_TABUNGAN'] == '3') {
                                                                    echo 'Hewan Ternak';
                                                                } else if ($row['JENIS_TABUNGAN'] == '4') {
                                                                    echo 'Kapal Motors';
                                                                } else if ($row['JENIS_TABUNGAN'] == '0') {
